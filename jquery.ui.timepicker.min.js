...
delay:0,minLength:0}).addClass("ui-widget ui-widget-content ui-corner-left")},_formatTime:function(a){var c=a.getHours(),b=this.options.show24Hours?c:(c+11)%12+1;a=a.getMinutes();return this._formatNumber(b)+this.options.separator+this._formatNumber(a)+(this.options.show24Hours?"":c<12?" am":" pm")},_formatNumber:function(a){return(a<10?"0":"")+a},_timeToDate:function(a){return typeof a=="object"?this._normaliseTime(a):this._timeStringToDate(a)},_timeStringToDate:function(a){if(a){var c=a.split(self.options.separator),
b=parseFloat(c[0]);c=parseFloat(c[1]);if(!self.options.show24Hours)if(b===12&&a.substr("AM")!==-1)b=0;else if(b!==12&&a.indexOf("PM")!==-1)b+=12;return this._normaliseTime(new Date(0,0,0,b,c,0))}return null},_normaliseTime:function(a){a.setFullYear(2001);a.setMonth(0);a.setDate(0);return a}})})(jQuery);